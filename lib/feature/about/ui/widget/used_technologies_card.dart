    ...
    return AboutPageCard(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            hyperLink(
              'Aplikacja jest oparta na frameworku [Flutter](https://flutter.dev) i napisana w języku [Dart](https://dart.dev). Interfejs użytkownika (UI) został zaprojektowany w duchu [Material Design 3](https://m3.material.io) od Google. Oto najważniejsze wykorzystane biblioteki:',
            ),
            Gap(5),
            Padding(
            ...
            Gap(5),
            hyperLink(
              'Dużą rolę w pracy nad aplikacją odegrał [ChatGPT](https://openai.com/chatgpt/overview/), którego wykorzystałem do nauki teorii rozkładów prwadopodobieństwa, ale także do pracy programistycznej (tworzenie funkcji matematycznych w kodzie).',
            ),
            Gap(15),
            Row(
