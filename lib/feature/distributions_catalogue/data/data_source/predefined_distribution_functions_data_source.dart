...
import 'package:zobmat25_2/feature/distributions_catalogue/data/data_source/distributions/discrete/beta_binomial_distribution.dart';
...
class PredefinedDistributionFunctionsDataSourceImpl
  ...
  Future<DiscreteDistributionFunctions> getDiscreteFunctions(
    ...
    return switch (distributionId) {
      ...
      'beta_binomial_distribution' => DiscreteDistributionFunctions(
          pmf: betaBinomialDistributionPmf,
          cdf: betaBinomialDistributionCdf,
          getChartRange: betaBinomialDistributionRangeGetter,
        ),
  ...
  Future<DistributionPropertyFunctions> getPropertyFunctions(
    ...
    return switch (distributionId) {
      ...
      'beta_binomial_distribution' => DistributionPropertyFunctions(
          expectedValue: betaBinomialDistributionExpectedValue,
          variance: betaBinomialDistributionVariance,
          standardDeviation: betaBinomialDistributionStandardDeviation,
          median: betaBinomialDistributionMedian,
          mode: betaBinomialDistributionMode,
        ),
